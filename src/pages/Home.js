  ...
  return (
    ...
    >
        <div className="innerCon">
          ...
          >
              <div className='flex flex-col lg:flex-row pt-2 w-[80vw] justify-center items-center relative z-10'>
                <h1 className="h1 text-[18vw]">
                  Michaela
                </h1>
                <h1 className="h1 text-[18vw] -mt-20 lg:mt-0">
                  Vivant
                </h1>
              </div>
                <p className="text-[3vw] lg:text-[36px] font-one lg:font-normal mb-4 lg:mb-12 -mt-16 relative z-10">
                 P&nbsp;H&nbsp;O&nbsp;T&nbsp;O&nbsp;G&nbsp;R&nbsp;A&nbsp;P&nbsp;H&nbsp;Y
                  ...
                  <motion.div 
                    ...
                    exit={{ scale: 0 }}
                    transition={transition1}
                    className='w-auto h-auto lg:w-[80vw] lg:h-auto overflow-hidden relative mb-8 -mt-32 lg:-mt-52'
                  >
               <motion.img
            ...
            <Link to="/weddings" className="btn relative z-10">
               View my work
                   ...
                   <blockquote 
                     ...
                     data-instgrm-permalink="https://www.instagram.com/p/DDAQd-SRLq_/?utm_source=ig_embed&amp;utm_campaign=loading" 
                   ...
                   >
                     <div style={{padding:'16px'}}> 
                       <a href="https://www.instagram.com/p/DDAQd-SRLq_/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ background:'#FFFFFF', lineHeight:'0', padding:'0 0', textAlign:'center', textDecoration:'none', width:'100%' }} target="_blank" rel="noopener noreferrer"> 
                       ...
                       <p style={{ color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', lineHeight:'17px', marginBottom:0, marginTop:'8px', overflow:'hidden', padding:'8px 0 7px', textAlign:'center', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
                         <a href="https://www.instagram.com/p/DDAQd-SRLq_/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color:'#c9c8cd', fontFamily:'Arial,sans-serif', fontSize:'14px', fontStyle:'normal', fontWeight:'normal', lineHeight:'17px', textDecoration:'none' }} target="_blank" rel="noopener noreferrer">A post shared by MN Wedding Photographer (@michaelavivantphoto)</a>
                       </p>
                     </div>
                   </blockquote>
                 </div>
